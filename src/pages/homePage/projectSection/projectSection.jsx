  ...
  return (
    <>
      <section
        ...
        <div className="grid grid-cols max-w-5xl lg:max-w-6xl lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
          <ProjectCard />
          <ProjectCard />
          <ProjectCard />
        </div>
        <Link to="/projects" className="text-white w-auto h-auto py-3 px-6 bg-purple-600 rounded-md">Check Out my Latest Work</Link>
      </section>
    </>
  )
}