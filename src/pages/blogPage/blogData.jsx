...
export const blogData = [
    {
        id: "blog-1",
        image: "/angel-photos/angel-designer.webp",
        images: [
    ...
    {
        id: "blog-2",
        image: "/angel-photos/team1.webp",
        images: [
            "/angel-photos/team1.webp",
            "/angel-photos/best-costume.webp",
        ],
        heading: "Beyond the Screen",
        description: "I believe that great design is built not only through skills but also through collaboration. During our year-end gathering and costume party, I had the chance to connect with my teammates outside work. I even received the Best Cowboy Costume award, a fun reminder that I value creativity and building positive relationships in every setting."
    },
    {
        id: "blog-3",
        image: "/angel-buenavista-web-designer-hero-1240.webp",
        images: [
